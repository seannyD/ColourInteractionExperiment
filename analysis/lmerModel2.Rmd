...
Results of the model comparison tests.  Each row represents an increasingly complex model, with each fixed effect being added one at a time.  The statistics describe the change in how well the model fits the data after adding each fixed effect.  A significant result suggests that the fixed effect significantly improves the fit of the model, and therefore is a good predictor of frequency of variants in the first week.
