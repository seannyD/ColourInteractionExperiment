...
```{r}
variants = variants[!variants$sign %in% c("SAME","DIFFERENT"),]
```
...
variants$T_minus_1.any = variants$T_minus_1>0
...
variants$TryMarked.any = variants$TryMarked>0
...
mRIndx = update(finalModel, ~. + (0 + indexical | colourName), control=rsControl)
...
sumStats2$TryMarked.any = c("No","Yes")[1+sumStats2$TryMarked.any]
